...
public class ViewConstants {
    ...
    public static final int MAIN_VIEW_TABLE_MOVIE_COLUMN_WIDTH = 385;
    public static final String MAIN_VIEW_TABLE_MOVIE_COLUMN_NAME = "Nazwa filmu";

    public static final int MAIN_VIEW_TABLE_STATUS_COLUMN_WIDTH = 104;
    public static final String MAIN_VIEW_TABLE_STATUS_COLUMN_NAME = "Status";

    public static final int MAIN_VIEW_TABLE_WATCHER_COLUMN_WIDTH = 365;
